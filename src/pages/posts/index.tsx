...
function PostListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<PostInterface[]>(
    ...
    () =>
      getPosts({
        relations: ['user', 'subreddit', 'comment.count', 'upvote.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('subreddit', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>subreddit</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('subreddit', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/subreddits/view/${record.subreddit?.id}`}>
