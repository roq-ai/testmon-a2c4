...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin-user', 'subreddit-moderator', 'content-creator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Upvote', path: '/upvotes', entity: 'upvote', service: AccessServiceEnum.PROJECT, icon: FiThumbsUp },
